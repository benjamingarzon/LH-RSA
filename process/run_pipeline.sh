...
#./pipeline.sh lue001 1 trialsfile-lup2s001_fmri.csv 32 $PHASE "1 2 3 4 5" organize_responses.py "2.1 0.5 0 6.0" "26,27,28,29,30,31"&
#./pipeline.sh lue001 2 trialsfile-lup2s001_fmri.csv 32 $PHASE "1 2 3 4 5" organize_responses.py "2.1 0.5 0 6.0" "26,27,28,29,30,31"&
./pipeline.sh lue001 3 trialsfile-lup2s001_fmri.csv 32 $PHASE "1 2 3 4 5" organize_responses.py "2.1 0.5 0 6.0" "26,27,28,29,30,31"
...
#for PHASE in 8 9 10; do #PHASE=8
#PHASE=6
