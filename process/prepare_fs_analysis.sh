...
RESULTS_FILE=results_unsmoothed
...
mkdir $SUBJECTS_DIR/$RESULTS_FILE/
# gather all
ls $SUBJECTS_DIR/sub-*.?.long.sub-*.base/surf/rh.${METRIC}.nii.gz | cut -d'-' -f2 | cut -d '.' --output-delimiter ' ' -f1,2 > $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.txt
ls $SUBJECTS_DIR/sub-*.?.long.sub-*.base/surf/lh.${METRIC}.nii.gz | cut -d'-' -f2 | cut -d '.' --output-delimiter ' ' -f1,2 > $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.txt

fslmerge -t $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.nii.gz $SUBJECTS_DIR/sub-*.?.long.sub-*.base/surf/rh.${METRIC}.nii.gz 
fslmerge -t $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.nii.gz $SUBJECTS_DIR/sub-*.?.long.sub-*.base/surf/lh.${METRIC}.nii.gz 

mris_convert --to-scanner $SUBJECTS_DIR/fsaverage/surf/lh.white \
$SUBJECTS_DIR/$RESULTS_FILE/lh.white.gii

mris_convert --to-scanner $SUBJECTS_DIR/fsaverage/surf/rh.white \
$SUBJECTS_DIR/$RESULTS_FILE/rh.white.gii

fslmaths $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.nii.gz -Tmean $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}_mean.nii.gz
fslmaths $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.nii.gz -Tmean $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}_mean.nii.gz

$HCPDIR/wb_command -metric-convert -from-nifti \
$SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}_mean.nii.gz \
$SUBJECTS_DIR/$RESULTS_FILE/lh.white.gii \
$SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}_mean.func.gii

$HCPDIR/wb_command -metric-convert -from-nifti \
$SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}_mean.nii.gz \
$SUBJECTS_DIR/$RESULTS_FILE/rh.white.gii \
$SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}_mean.func.gii

rm $SUBJECTS_DIR/$RESULTS_FILE/?h.${METRIC}_mean.nii.gz 

# mean of std
if [ ]; then
for GROUP in 1 2; do 
    fslmerge -t $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.${GROUP}.std.nii.gz $SUBJECTS_DIR/sub-lue1${GROUP}*.base/surf/rh.${METRIC}.std.nii.gz
    fslmerge -t $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.${GROUP}.std.nii.gz $SUBJECTS_DIR/sub-lue1${GROUP}*.base/surf/lh.${METRIC}.std.nii.gz
    fslmaths $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.${GROUP}.std.nii.gz -Tmean $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.${GROUP}.std.nii.gz
    fslmaths $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.${GROUP}.std.nii.gz -Tmean $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.${GROUP}.std.nii.gz
    
    $HCPDIR/wb_command -metric-convert -from-nifti \
    $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.${GROUP}.std.nii.gz \
    $SUBJECTS_DIR/$RESULTS_FILE/lh.white.gii \
    $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.${GROUP}.std.func.gii
    
    $HCPDIR/wb_command -metric-convert -from-nifti \
    $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.${GROUP}.std.nii.gz \
    $SUBJECTS_DIR/$RESULTS_FILE/rh.white.gii \
    $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.${GROUP}.std.func.gii

done 
fi
rm $SUBJECTS_DIR/$RESULTS_FILE/?h.${METRIC}.*std.nii.gz $SUBJECTS_DIR/$RESULTS_FILE/?h.${METRIC}_mean.nii.gz #$SUBJECTS_DIR/sub-*.?.long.sub-*.base/surf/?h.${METRIC}.nii.gz
rm $SUBJECTS_DIR/sub-*.base/surf/?h.${METRIC}.?.std.nii.gz $SUBJECTS_DIR/$RESULTS_FILE/?h.white.gii

cd $SUBJECTS_DIR/$RESULTS_FILE
...
#freeview -f $SUBJECTS_DIR/fsaverage/surf/lh.inflated:overlay=$SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.std.diff.func.gii $SUBJECTS_DIR/fsaverage/surf/rh.inflated:overlay=$SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.std.diff.func.gii
#freeview -f $SUBJECTS_DIR/fsaverage/surf/lh.inflated:overlay=$SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}_mean.func.gii $SUBJECTS_DIR/fsaverage/surf/rh.inflated:overlay=$SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}_mean.func.gii
...
##fslmaths $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.nii.gz -Tmean -bin $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.mask.nii.gz
##fslmaths $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.nii.gz -Tmean -bin $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.mask.nii.gz

# create a mask in motor cortex
#fslmaths $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.nii.gz -Tmean -thr 3 -bin $SUBJECTS_DIR/$RESULTS_FILE/lh.${METRIC}.small.mask.nii.gz
#fslmaths $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.nii.gz -Tmean -thr 3 -bin $SUBJECTS_DIR/$RESULTS_FILE/rh.${METRIC}.smallmask.nii.gz

mris_convert --to-scanner $SUBJECTS_DIR/fsaverage/surf/lh.pial $SUBJECTS_DIR/$RESULTS_FILE/lh.fsaverage.white.gii
mris_convert --to-scanner $SUBJECTS_DIR/fsaverage/surf/rh.pial $SUBJECTS_DIR/$RESULTS_FILE/rh.fsaverage.white.gii
