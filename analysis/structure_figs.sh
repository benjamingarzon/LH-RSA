...
$HOMEDIR/Software/LeftHand/analysis/show_surface.sh $FIGS_DIR $WD/lh.accuracy.map $WD/rh.accuracy.map 0.5 0.7 multivar-tess-thickness $LH_INFLATED $RH_INFLATED

# 6. Coefficients
# 7. Violin plots for accuracy

#v8. Multivariate VBM
WD=$HOMEDIR/Data/LeftHand/Lund1/cat12crossbias8_10//tests/multivariate-tess/
$HOMEDIR/Software/LeftHand/analysis/show_surface.sh $FIGS_DIR $WD/lh.accuracy.map $WD/rh.accuracy.map 0.5 0.7 multivar-tess-vbm $LH_INFLATED $RH_INFLATED
# 9. Coefficients
